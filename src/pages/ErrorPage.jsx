    ...
    <div className="min-h-screen bg-white text-black font-body flex flex-col items-center justify-center p-8 overflow-hidden relative selection:bg-accent selection:text-white">
      ...
      <div className="relative z-10 text-center max-w-2xl flex flex-col items-center">
        ...
        <div className="mb-10 relative group">
          <div className="w-24 h-24 border-4 border-black flex items-center justify-center bg-white relative z-10">
            <svg
              ...
              strokeWidth={2.5}
              stroke="currentColor"
              className="w-10 h-10 text-black group-hover:text-accent group-hover:rotate-12 transition-all duration-500"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <Link to="/home">
            <button className="bg-black text-white px-12 py-4 font-heading font-black uppercase tracking-[0.3em] text-[11px] hover:bg-accent transition-all group relative overflow-hidden shadow-2xl cursor-pointer rounded-md">
          ...
          <button
            onClick={back}
            className="border-2 border-black px-12 py-4 font-heading font-black uppercase tracking-[0.3em] text-[11px] hover:bg-black hover:text-white transition-all active:scale-95 cursor-pointer rounded-md"
          >
            Previous Sector
          </button>
        </div>
