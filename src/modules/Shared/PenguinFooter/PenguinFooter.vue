    ...
    <div class="container">
            ...
            <div class="" id="mc_embed_signup">
              ...
              <form target="_blank" novalidate="true"
                ...
                <div class="d-flex flex-row">
                  ...
                  <button class="click-btn btn btn-default"><span class="material-icons enter-icon">
                      arrow_forward
                    </span></button>
      ...
      <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
        <p class="footer-text m-0">
          Copyright &copy; All rights reserved by | <a href="https://foysalmahmood-portfolio.web.app/"
            target="_blank">Foysal Mahmood</a>
...
<style scoped src="./PenguinFooter.css"></style>
