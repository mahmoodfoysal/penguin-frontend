...
const SubCategory = () => {
  ...
  const handleSubmit = async () => {
    setIsInvalid(false);
    if (
      !formData.parCatInfo.par_cat_name ||
      !formData.parCatInfo.par_cat_id ||
      !formData.sub_cat_name ||
      !formData.sub_cat_id ||
      !userInfo?.email ||
      !formData.status
    ) {
    ...
    const data = {
      ...
      par_cat_name: formData.parCatInfo.par_cat_name,
          ...
          <table className="w-full text-left border-collapse">
            ...
            <thead className="hidden md:table-header-group bg-base-200/50 font-heading text-[10px] uppercase tracking-widest font-black opacity-40">
              <tr>
                ...
                <th className="px-8 py-4">Sub Category Name</th>
                <th className="px-8 py-4 text-center">Sub Category ID</th>
              ...
              <div className="flex-grow space-y-10 overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full border-b-2 ${
                      isInvalid && !formData.sub_cat_name
                        ? "border-red-600"
                        : "border-base-content/10"
