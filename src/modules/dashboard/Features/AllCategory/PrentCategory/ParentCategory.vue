...
import { getParentCategory, postParentCategory, updateParentCategoryStatus, deleteParentCategory } from '@/modules/dashboard/api/categories.js';
...
const handleDeleteCategory = async (id) => {
  try {
    const text = "Are you want to sure?";
    if(confirm(text) === true) {
      const result = await deleteParentCategory(id);
